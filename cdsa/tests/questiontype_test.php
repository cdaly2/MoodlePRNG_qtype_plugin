...
/**
 * Unit tests for the cdsa question type class.
 *
 * @package    qtype_cdsa
...
global $CFG;
require_once($CFG->dirroot . '/question/type/cdsa/questiontype.php');
require_once($CFG->dirroot . '/question/engine/tests/helpers.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/cdsa/edit_shortanswer_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_cdsa_test extends advanced_testcase {
    public static $includecoverage = array(
        'question/type/questiontypebase.php',
        'question/type/cdsa/questiontype.php',
    );

    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_cdsa();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'cdsa');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('cdsa');
    ...
    public function test_get_possible_responses_no_star() {
        $q = test_question_maker::get_question_data('cdsa', 'frogonly');
    ...
    public function test_question_saving_frogtoad() {
        ...
        $questiondata = test_question_maker::get_question_data('cdsa');
        $formdata = test_question_maker::get_question_form_data('cdsa');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_cdsa_edit_form::mock_submit((array)$formdata);

        $form = qtype_cdsa_test_helper::get_question_editing_form($cat, $questiondata);
